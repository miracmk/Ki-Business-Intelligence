...
import { kibiEntities, subscriptions } from '../../../db/schema.js';
...
export async function startCrmScheduler() {
...
async function runSchedulerCycle() {
    ...
    for (const conn of connections) {
        try {
            ...
            runEntityEtl(conn.id).catch(err => console.error(`[CrmScheduler] ETL failed for ${conn.id}:`, err));
        }
        catch (err) {
...
//# sourceMappingURL=crm-scheduler.js.map